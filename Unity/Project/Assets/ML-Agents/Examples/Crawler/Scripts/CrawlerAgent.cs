...
public class CrawlerAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        //TargetWalkingSpeed = Random.Range(1.0f, m_maxWalkingSpeed);
        TargetWalkingSpeed = 12.0f;
    }
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        bpDict[leg0Upper].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg1Upper].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg2Upper].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg3Upper].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg0Lower].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg1Lower].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg2Lower].SetJointTargetRotation(0, continuousActions[++i], 0);
        bpDict[leg3Lower].SetJointTargetRotation(0, continuousActions[++i], 0);
